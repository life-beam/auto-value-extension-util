 ...
 *
 * Taken from com.google.auto.value.processor.Optionalish with small modifications.
 *
 * TODO: remove when https://github.com/google/auto/issues/359 is resolved
 *
...
public class Optionalish {
    ...
    /**
     * Returns a string representing the method call to obtain the value represented by this
     * Optional.
     *
     * This will be something like {@code "get()"} or possibly {@code "getAsInt()"}. It does not
    ...
    public String getGet() {
        ...
        if (name.endsWith("OptionalDouble")) {
            return "getAsDouble()";
        } else if (name.endsWith("OptionalInt")) {
            return "getAsInt()";
        } else if (name.endsWith("OptionalLong")) {
            return "getAsLong()";
        } else {
            return "get()";
        }
